!function(f){"object"==typeof exports&&"undefined"!=typeof module?module.exports=f():"function"==typeof define&&define.amd?define([],f):("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).iModal=f()}(function(){return function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var p="function"==typeof require&&require;if(!f&&p)return p(i,!0);if(u)return u(i,!0);throw(p=new Error("Cannot find module '"+i+"'")).code="MODULE_NOT_FOUND",p}p=n[i]={exports:{}},e[i][0].call(p.exports,function(r){return o(e[i][1][r]||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}({1:[function(require,module,exports){module.exports={success:{color:"text-white",btn:"light"},primary:{color:"text-white",btn:"light"},info:{color:"text-white",btn:"light"},warning:{color:"text-white",btn:"light"},danger:{color:"text-white",btn:"light"},secondary:{color:"text-white",btn:"light"},dark:{color:"text-white",btn:"light"},light:{color:"text-dark",btn:"dark"}}},{}],2:[function(require,module,exports){module.exports=function(out){out=out||{};for(var i=1;i<arguments.length;i++)if(arguments[i])for(var key in arguments[i])arguments[i].hasOwnProperty(key)&&(out[key]=arguments[i][key]);return out}},{}],3:[function(require,module,exports){const{setGlobalsSettings,combinedSettings}=require("./settings"),bgColors=require("./bgColors");const isActive=function(){return!!document.querySelector(".modal.iModal")},dispose=function(){document.querySelector(".modal.iModal")&&($(".modal.iModal").modal("dispose").remove(),$(".modal-backdrop").remove(),$("body").removeClass("modal-open"))},hide=function(){isActive()&&$(".modal.iModal").modal("hide")};module.exports=function(params){let settings=combinedSettings(params),modal=document.createElement("div");modal.id=settings.id,modal.tabIndex=-1,modal.classList.add("modal","iModal"),settings.fade&&modal.classList.add("fade");let modal_dialog=document.createElement("div");modal_dialog.classList.add("modal-dialog"),settings.size&&modal_dialog.classList.add(settings.size),settings.dialogScrollable&&modal_dialog.classList.add("modal-dialog-scrollable"),settings.dialogCentered&&modal_dialog.classList.add("modal-dialog-centered"),modal.appendChild(modal_dialog);let modal_content=document.createElement("div");if(modal_content.classList.add("modal-content"),settings.bg&&(modal_content.classList.add(`bg-${settings.bg}`),modal_content.classList.add(bgColors[settings.bg].color)),modal_dialog.appendChild(modal_content),settings.header){let modal_header=document.createElement("div");modal_header.classList.add("modal-header"),settings.headerClass&&(modal_header.classList.add(`bg-${settings.headerClass}`),modal_header.classList.add(bgColors[settings.headerClass].color)),modal_header.innerHTML=`
